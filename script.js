...
// Change this URL to your public website URL
const PUBLIC_URL = "https://pawans-birthday.github.app";
...
function generateQRCode() {
    ...
    try {
        ...
        qrContainer.innerHTML = "<p style='color: red;'>Unable to generate QR code. Check the PUBLIC_URL.</p>";

    }

}

// Generate QR code when welcome screen unlocks
function checkPassword(){
    ...
    if(passwordInput === PASSWORD){
        ...
        setTimeout(()=>{
            ...
            setTimeout(()=>{
                ...
                // Generate QR code after main website is displayed
                setTimeout(() => {
